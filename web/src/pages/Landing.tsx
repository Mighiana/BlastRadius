...
export default function Landing() {
  ...
  return <>
    ...
    <section className="container section faq-section"><div className="section-intro"><LockKeyhole size={24} aria-hidden="true" /><p className="eyebrow">CLEAR BOUNDARIES</p><h2>Security decisions deserve honest answers.</h2></div>
      <div className="faq">{[
        ['Does SAFE mean my infrastructure is secure?', 'No. It means this comparison introduces no new exposure under the supported static model. Unsupported resources, policy conditions and Terraform constructs can limit coverage. Read diagnostics before relying on a result.'],
        ...
        ['Can I connect a GitHub repository here?', 'Repository connections and a GitHub App are not implemented. Use the documented GitHub Actions workflow in your own repository, or upload HCL and plan JSON to a workspace.'],
        ['Can I pay for a subscription?', 'Billing is test mode only. Free, Pro and Team define enforced usage limits. Test checkout and portal are available only when the operator configures Stripe sandbox credentials. No live payments are supported.'],
